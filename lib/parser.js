...
function nextNonWhitespaceToken(state, dialect = "generic") {
    let token;
    do {
        state = initState({ prevState: state });
        token = (0, tokenizer_1.scanToken)(state, dialect);
...
function stateMachineStatementParser(statement, steps, { isStrict, dialect }) {
    ...
    return {
        ...
        addToken(token, nextToken) {
            ...
            if (
            // TODO: tokenize this?
            token.value.match(PRE_TABLE_KEYWORDS) && !statement.isCte && ((_a = statement.type) === null || _a === void 0 ? void 0 : _a.match(/SELECT|INSERT/))) {
